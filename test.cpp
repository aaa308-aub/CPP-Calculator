...
int main() {
    ...
    inputs.emplace_back("5+-*7");                                // 49
        // 50 -- extremely long input:
    inputs.emplace_back("");
        // 51 -- extremely long input, with multiplication:
    inputs.emplace_back("99999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999*99999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999");
